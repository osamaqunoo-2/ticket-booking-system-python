...
class PaymentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeletePayment = channel.unary_unary(
                '/payment.PaymentService/DeletePayment',
                request_serializer=payment__pb2.PaymentIdRequest.SerializeToString,
                response_deserializer=payment__pb2.PaymentResponse.FromString,
                _registered_method=True)
        self.GetAllPayments = channel.unary_unary(
                '/payment.PaymentService/GetAllPayments',
...
def add_PaymentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeletePayment': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=payment__pb2.PaymentIdRequest.FromString,
                    response_serializer=payment__pb2.PaymentResponse.SerializeToString,
            ),
...
class PaymentService(object):
    ...
    def DeletePayment(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/payment.PaymentService/DeletePayment',
            payment__pb2.PaymentIdRequest.SerializeToString,
            payment__pb2.PaymentResponse.FromString,
            options,
            channel_credentials,
            insecure,
